...
export default function Forms({sections, setSections}) {
  ...
  return (
    ...
    <div className="btn-container">
      ...
      <input className="btn" type="button" value={'\u2B73'} title="Download or Print" onClick={() =>{print()}}/>   
    </div>
    {/* Help Section */}
    {<div className={"section-wrapper " + (activity[0] ? "active" : "inactive") + " help"}>
      ...
      <li>For Experience section, To separate lines within the section, use <b>;;</b>. <br></br>Example: 
